  ...
  return (
    <div className="flex w-full justify-center px-4 py-2">
      <form onSubmit={onSubmit} className="w-full max-w-md">
        <div className="flex w-full shadow-sm border border-base-300 rounded-btn overflow-hidden">
          <div className="flex items-center bg-base-200/50 pl-3 flex-1">
            <svg
          ...
          <button
            type="submit"
            className="btn btn-primary rounded-none h-12 px-6 font-semibold"
          >
            Search
          </button>
        </div>
